...
namespace SolearyAPI.Controllers
{
    public class UsersController : ApiController
    {
        ...
        {
            return db.Users.Include("Company");
        }
        ...
        {
            User user = await db.Users.Include("Company").FirstOrDefaultAsync(x=>x.UserID == id);
            if (user == null)
            {
                return NotFound();
            }
        ...
        public async Task<IHttpActionResult> PostUser(User user)
        {
            ...
            user.SaltedAndHashedPassword = Utils.hash(user.Password, user.Salt);
            db.Users.Add(user);
